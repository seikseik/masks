...
function preload() {
    bocca = loadImage('images/faccia_02/bocca_2.png');
    naso = loadImage('images/faccia_02/naso_2.png');
    orecchioSx = loadImage('images/faccia_02/orecchioSx_2.png');
    orecchioDx = loadImage('images/faccia_02/orecchioDx_2.png');
    occhio = loadImage('images/faccia_02/occhio_2.png');
...
function Eye(d) {
  ...
  this.display = function(x, y, d) {
    ...
    fill(255);
    image(occhio, eye1X, eye1Y + (d*0.38),  d*1.3, (d+20)*1.1)
    image(occhio, eye2X, eye2Y + (d*0.38) , d*1.3, (d+20)*1.1)
    noStroke();
    // fill(55,0,169);
    fill(254,20,164);
    ellipse(eye1X, eye1Y, d*0.18);
    ellipse(eye2X, eye2Y , d*0.18);
    fill(55,0,169);
    ellipse(eye1X, eye1Y, d*0.10);
    ellipse(eye2X, eye2Y , d*0.10);
...
function Nose(d) {
  ...
  this.display = function(x, y, d) {
    ...
    image(naso, noseX, noseY- (d*0.2), d * 0.6, d * 1);
  }
}
...
function rightEarFunction(d) {
  ...
  this.display = function(x, y, d) {
    ...
    image(orecchioSx, ear1X-(d*0.4), ear1Y, d * 0.7 , d * 1);
...
function leftEarFunction(d) {
  ...
  this.display = function(x, y, d) {
    ...
    image(orecchioDx, ear2X+(d*0.4), ear2Y, d * 0.7 , d*1);
...
function Mouth(d) {
  this.display = function(x, y, d) {
    ...
    image(bocca, mouthX, mouthY +(d*0.7), d*1.3, d *0.6);
  }
}
